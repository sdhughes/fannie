...
if (isset($_REQUEST['submitted']) && $_REQUEST['submitted'] == 'search') { // On form submission or list link clicking...
    ...
    if (isset($_REQUEST['upc']) && !empty($_REQUEST['upc'])) {
        ...
        $query = "SELECT upc, description, normal_price, qttyEnforced, foodstamp, deposit, scale, discount, discounttype, inUse, subdept, department, special_price, start_date, end_date
