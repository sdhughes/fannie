...
$header = 'Suspended Transactions Left Open';
...
*/    
	...
	$order_by = 'date DESC';
        ...
        $query = "SELECT DATE(datetime) AS date,
                ...
                FROM suspended_archive
                WHERE 
".//                 description LIKE 'Subtotal%'
...
/*
	...
	'.
//	<p>Date: </td><td><input type="text" name="date" class="datepick" size="11" maxlength="11" /> * Required</p>
'</td></tr>';
