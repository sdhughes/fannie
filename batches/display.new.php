...
?>
 ...
 //   alert('heyo');
        $(document).ready(function() {
            $('#addItemDiv').load('addItems.php',{'batchID':'<?php echo $batchID ?>','submit':'submit'},function(data){});
            $('#batchesDiv').load('batches.php',{'batchID':'<?php echo $batchID ?>','submit':'submit'},function(data){
                    //$(this).html(data);
            });    
