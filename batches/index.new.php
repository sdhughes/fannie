...
//if (isset($_POST["delete"]) && is_array($_POST["deleteList"])) {print_r $_POST["deleteList"];}
        ...
        echo '<p align="center"><input name=showinactive id="toggleBatches" type=submit value="Show Inactive" /></p>';

echo '<form action="'. $_SERVER['PHP_SELF'] . '" method="POST">';

/*
if ($_POST['showinactive'] == 'hide') {
        echo '<p align="center"><BUTTON name=showinactive id="inactive_toggle" type=submit value="show">Show Inactive Batches</BUTTON><input name=showinactive type=hidden value="show" /></p>';
} elseif ($_POST['showinactive'] == 'show') {
        echo '<p align="center"><BUTTON name=showinactive type=submit id="inactive_toggle" value="hide">Hide Inactive Batches</BUTTON><input name=showinactive type=hidden value="hide" /></p>';
}*/
