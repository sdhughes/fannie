    ...
    */
    ...
    class chainedSelectors
    {
        ...
        */
        ...
        function printUpdateFunction($department, $subdepartment)
        {
            /*
            ...
            */
            ...
            {
				if($sourceValue == $department) {		// [12] = Department number
					$selected_index = $subdepartment;		// [28] = subdept. #
        ...
        function printSelectors($item_selected)
        {
            ...
            */
            ...
            foreach($this->uniqueChoices as $key=>$value)
            {
                ...
                if($key == $item_selected) 	// [12] = department
                {
