...
function drawForm($msg = NULL, $_POST = NULL) {
    ...
    $header = 'Department Movement Report for Training Mode';
...
EOS;
    printf('<div id="box">
	   %s
	    ...
	    <div align="center"><button name="selectAll" id="selectAll" type="button">All Departments</button></div>
            <form method="post" target="_blank" action="%s">', $msg, $_SERVER['PHP_SELF']);

    //create the dept picker
    echo "<div class='dept_picker'>";
