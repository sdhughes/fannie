...
echo '<body>
	<a href="/reports/salesTool.php">Sales Tool</a><br />
        Report on the sales of things.
</br><br />
	<a href="/reports/dept_movement.php">Department Movement</a></br>
	Product movements by department or group of departments
</br></br>
	<a href="/reports/simpleDeptSales.php">Department Sales</a></br>
	Product movements by department or group of departments
</br></br>
...
<!--        <a href="/reports/activeMembers.php">Active Members Report</a><br />
        ...
        <a href="/reports/ncgaNumbers.php">Executive Report</a><br />
        Pulls a summary of Sales Data and Customer Count from a date range.
</br><br />
