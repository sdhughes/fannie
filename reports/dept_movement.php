...
<?php
	...
	$newDeptArray = $_POST['dept'];

	foreach ($_POST['dept'] as $selectedDept) {
	...
	$newDeptString = implode($newDeptArray, ",");

	$deptArray = $newDeptString;
	...
	if ($i == $year2) {
	    ...
	    $salesQ .= ") AS yearSpan GROUP BY dept ORDER BY dept_no";
   ...
   /* 
	//DEBUG
	echo "sales: " . $salesQ . "<br />";
	echo "open ring: " . $openQ . "<br />";
	echo "shrink: " . $shrinkQ . "<br />";
	//DEBUG
*/
